...
public class ClienteGUIListagem extends JDialog {
    ...
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"RG","Nome Cliente","Endereco","Email","Telefone"}, 0);
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"RG","Nome Cliente","Endereco","Email","Telefone"}, 0);
        int aux = 0;
