...
public class FuncionarioGUIListagem extends JDialog {
    ...
    static DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID","Nome Funcionario","Endereco","Telefone","Email"}, 0);
    ...
    public void atualizaTabela() {
        DefaultTableModel modelo = new DefaultTableModel(new String[]{"ID","Nome Funcionario","Endereco","Telefone","Email"}, 0);
        int aux = 0;
